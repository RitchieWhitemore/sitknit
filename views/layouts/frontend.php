                    ...
                    <div class="filter filter--closed">
                        <form class="filter__form" method="post" action="">
                            ...
                            <fieldset class="filter__group">
                                ...
                                <label><input type="checkbox" name="filter-manufacturer"><span
                                            class="filter__item-span"></span>Adelia</label><br>
                                <label><input type="checkbox" name="filter-manufacturer" checked><span
                                            class="filter__item-span"></span>Alize</label><br>
                                <label><input type="checkbox" name="filter-manufacturer"><span
                                            class="filter__item-span"></span>Alpina</label><br>
                                <label><input type="checkbox" name="filter-manufacturer"><span
                                            class="filter__item-span"></span>CANAN</label><br>
                                <label><input type="checkbox" name="filter-manufacturer"><span
                                            class="filter__item-span"></span>CHEVAL BLANC</label><br>
                                <label><input type="checkbox" name="filter-manufacturer"><span
                                            class="filter__item-span"></span>Color City</label><br>
                                <label><input type="checkbox" name="filter-manufacturer"><span
                                            class="filter__item-span"></span>HOOOKED</label>
                            </fieldset>
                        </form>
                    </div>
                </aside>
